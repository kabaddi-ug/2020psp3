...
## ソースコードの説明
l108 たどったかどうかの変数、ループや一時的に保存していく変数の設置
l110~112 visitedを初期化
l113 スタックを初期化
l114 出発点をスタックにプッシュ
l115~l126 スタックから取り出し、言ったことあるかチェック。
l116 スタックから取り出す。
l117~118 行ったことなければ行ったことにする。
l120~124 その場所からいける場所をスタックに入れる。
l127~129 結果を出力する

l194 たどったかどうかの変数、ループや一時的に保存していく変数の設置
l195~l196 visitedを初期化
l198 キューを初期化
l199 出発点をキューにプッシュ
l201~l212 キューから取り出し、言ったことあるかチェック。
l204 キューから取り出す。
l203~l204 行ったことなければ行ったことにする。
l206~l210 その場所からいける場所をキューに入れる。
l213~l215 結果を出力する
